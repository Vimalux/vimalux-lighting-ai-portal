const translations = {
  it: {
    ...
    technical: "Tecnica", savings: "Risparmi", financial: "Finanziaria", freight: "Trasporto", financingModel: "Tipo di progetto", financeSolution: "Finance solution", cashDeal: "Cash Deal", laas: "LaaS", ppp: "PPP",
    ...
    cloPercent: "Percentuale CLO", powerAidPercent: "Percentuale PowerAiD", powerAidShare: "Quota PowerAiD", existingMaintenance: "Manutenzione esistente / lampada / anno", newMaintenance: "Nuova manutenzione / lampada / anno",
    contractYears: "Anni di contratto", interestRate: "Tasso di interesse (%)", upfrontPayment: "Anticipo", energyEscalation: "Aumento energia (%)", opexEscalation: "Aumento OPEX (%)", discountRate: "Tasso di attualizzazione (%)", analysisPeriod: "Periodo di analisi", freightCost: "Costo trasporto / lampada", freightSales: "Prezzo trasporto / lampada",
  ...
  en: {
    ...
    technical: "Technical", savings: "Savings", financial: "Financial", freight: "Freight", financingModel: "Project type", financeSolution: "Finance solution", cashDeal: "Cash Deal", laas: "LaaS", ppp: "PPP",
    ...
    cloPercent: "CLO percentage", powerAidPercent: "PowerAiD percentage", powerAidShare: "PowerAiD share percentage", existingMaintenance: "Existing maintenance / lamp / year", newMaintenance: "New maintenance / lamp / year",
    contractYears: "Contract years", interestRate: "Interest rate (%)", upfrontPayment: "Upfront payment", energyEscalation: "Energy escalation (%)", opexEscalation: "OPEX escalation (%)", discountRate: "Discount rate (%)", analysisPeriod: "Analysis period", freightCost: "Freight cost / lamp", freightSales: "Freight sales / lamp",
